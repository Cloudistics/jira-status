...
class JiraStatus:
    ...
    def get_bug_stats(self, logger, jira_instance, project, component,
        ...
        logger.info(('There are {0} open bugs in {1}. '
    ...
    def get_epic_stats(self, logger, jira_instance, project, component,
        ...
        for epic in epics_to_track:
            ...
            logger.info(('There are {0} open stories out of {1} total '
    ...
    def send_status_email(self, mail_client, email_from, email_to,
                          email_subject, email_msg):
        """
        Send a status email via the supplied mail client.
        """
        mail_client.send_msg(email_from, email_to, email_subject, email_msg)
